<template>
  <div className="card m-4 p-4 is-flex is-flex-direction-column">
    <h1 className="title is-3 my-3 has-text-centered">Nuxt3 - Runtime Config</h1>
    <div className="m-4">
      <client-only>
        <p>
          <b>apiSecret <br/>(private - server side)</b>
        </p>
        <p className="mt-3 p-3 has-background-danger has-text-white">
      ...
      <div className="mt-4">
        ...
        <p className="mt-3 p-3 has-background-primary">
          {{ message }}
        </p>
      </div>
    </div>
