var _a, _b;
import { getCurrentInstance, reactive, toRef, isRef, inject, defineComponent, computed, ref, h, resolveComponent, version, nextTick, shallowRef, Suspense, Transition, provide, useSSRContext, defineAsyncComponent, onErrorCaptured, unref, createApp } from "vue";
...
const _routes = [
  {
    ...
    file: "/home/jferreira/nura/demos/nuxt3-env/pages/index.vue",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import("./_nuxt/index.9e9818a1.js").then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth.3721e08a.js")
};
...
const plugins_globalMiddleware_ts_Dhtf2HOPS3 = defineNuxtPlugin(() => {
...
const plugins_runtimeConfig_ts_s9BXXBz0gh = defineNuxtPlugin((nuxtApp) => {
  const config = useRuntimeConfig();
...
const _plugins = [
  ...
  plugins_globalMiddleware_ts_Dhtf2HOPS3,
  plugins_runtimeConfig_ts_s9BXXBz0gh
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.f3cd6e99.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
